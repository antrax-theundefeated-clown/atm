...
import Panels.NewUser;
import Panels.UserSelection;
...
public class ATM extends JFrame{
	...
	public static void main(String[] args) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				ATM atm = new ATM();
				atm.setExtendedState(JFrame.MAXIMIZED_BOTH);
				atm.setVisible(true);
...
//		
//		// init Bank
//		Bank theBank = new Bank("Bank of kunal and akshay");
//		
//		// add a user, which also creates a Savings account
//		User aUser = theBank.addUser("arora", "kunal", "1234");
//		
